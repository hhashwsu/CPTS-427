...
function wookitty_orders_sql_init() {
	...
	$sql = $wpdb->prepare( "SHOW TABLES LIKE'".$db_wookitty_settings_tbl."' ;");
	...
	if ( 0 == count( $res ) ) {
		$sql = $wpdb->prepare( "INSERT INTO $db_wookitty_settings_tbl (single_row, cats_autosync, rest_username, ".
